...
uint256 hashGenesisBlock("0x18fb470d48ecab66b93f86e89593096d235b0464b46c7d5a72dd8ff2815fbfa3");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Branch: 1 days
static const int64 nTargetSpacing = 300; // Branch: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe62743c3aa688681e2d692d8d4270cb93586c93b47dc3e283e37dc1c3455ebaa");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Barracuda is my favorite fish";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1502933036; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 857562;

        if (fTestNet)
        {
            block.nTime    = 1502927559;
            block.nNonce   = 3824;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe171a10e33f3c318a4c0b9fd080a0f38f3f8b222fe8663e595e9ce42c95a42e4"));
